...
const ASSETS = ["./", "./index.html", "./src/fullscreen.js", "./src/sfx.js", "./src/legacy.js", "./src/moba.js", "./src/battleshop.js", "./src/net.js", "./src/habitat.js", "./src/data/types-chart.js", "./manifest.json", "./icon.svg", "./dino.html",
  ...
  "./assets/field/ground.png", "./assets/views/leopard_front.png", "./assets/views/leopard_right.png", "./assets/views/leopard_back.png", "./assets/views/leopard_left.png", "./assets/bosses/snail.png", "./assets/bosses/iguana.png", "./assets/bosses/frog.png", "./assets/bosses/ibis.png"];
