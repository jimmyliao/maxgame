...
- **自然＋可愛動作**（v131）：對戰角色動作去生硬——① 跑動混合值 rb 緩動(起步/停步漸進、幅度全乘 rb) ② 轉身緩動(翻面壓扁再展開的紙片轉身，不瞬間鏡像) ③ 擠壓伸展(每步落地微壓扁/騰起微拉長) ④ 前傾跑姿＋上半身反向微擺(次級動作) ⑤ 抬腳微縮短=屈膝收腿 ⑥ 站立 idle 也有極輕重心搖晃 ⑦ 換腳落地冒腳步小土塵(dust，liteFX 停用) ⑧ 鮭魚/飛蟲不切腿改整體波動(擺尾/懸停)。
- **PWA 版本**：`sw.js` CACHE 目前 `shoutu-v131`。
